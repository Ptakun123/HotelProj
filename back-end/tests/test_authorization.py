...
class AuthorizationTestCase(unittest.TestCase):
    ...
    def test_register_success(self):
        ...
        self.assertIn(
            "Rejestracja zakończona pomyślnie", response.get_data(as_text=True)
        )
    ...
    def test_register_duplicate_email(self):
        ...
        self.assertIn("Email jest już zarejestrowany", response.get_data(as_text=True))
    ...
    def test_login_wrong_password(self):
        ...
        self.assertIn("Nieprawidłowy email lub hasło", response.get_data(as_text=True))
